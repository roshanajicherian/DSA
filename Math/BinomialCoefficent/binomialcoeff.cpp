//Solution to binomial coeff question on Hackerank
#include <bits/stdc++.h>
using namespace std;
...
long long int binomialCoeffecient(long long int n, long long int r)
{
    //nCr=n!/(n-r)!(r)!
...
void solve()
{
    ...
    cin >> a >> b >> n >> k;
    int r = n - k;
    int res = (binomialCoeffecient(n, r) % MOD * fastPower(a, k) % MOD) % MOD;
    res = (res % MOD * fastPower(b, n - k) % MOD) % MOD;
    cout << res << '\n';
}
int main()
{
